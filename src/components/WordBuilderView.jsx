    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ background: 'rgba(30,27,50,0.6)', borderRadius: '0 0 12px 12px', padding: '2rem' }}>
                ...
                {feedback && (
                    <div role="alert" aria-live="assertive" style={{ textAlign: 'center', padding: '1rem', marginBottom: '1rem', borderRadius: '12px', background: feedback.type === 'correct' ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)', border: `1px solid ${feedback.type === 'correct' ? '#22c55e' : '#ef4444'}` }}>

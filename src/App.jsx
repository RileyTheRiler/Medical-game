...
const MenuScreen = React.lazy(() => import('./components/MenuScreen'));
...
function App() {
  ...
  return (
    <>
      ...
      <Suspense fallback={<div style={{color: '#94a3b8', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>Loading...</div>}>
        {screen === 'menu' && (
          <MenuScreen
            stats={stats}
